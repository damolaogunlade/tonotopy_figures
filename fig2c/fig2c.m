...
for a = 1:length(ages)
    ...
    for i = 1:length(voxel_type{v})
        ...
        if i == 1
            ...
            lgd.FontSize= 6;
            sgtitle(sprintf("Example %s",age_char(1:end-1)))
        end
        % Add labels
