...
% 
% % For the new tonotopy experiment we added 8, 2 second TRs of rest at the beginning (16, 0.5 sec TRs) before and 4, 2 second
% % TRs (16, 0.5 sec TRs) after stimulus presentation   
% if isfield(scan,'paradigm')
%     stimImg = cat(1,zeros(16,length(scan.funcOf.x)),stimImg,zeros(16,length(scan.funcOf.x)));
%     scan.stimImg = stimImg;
% end
